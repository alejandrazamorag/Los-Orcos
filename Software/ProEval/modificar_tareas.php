...
<html lang="es">
	...
	<body>
		<header>
			...
			<h2>Insertar Tareas a Modificar del Proyecto "<?php echo $nombrep ?>" </h2>
			</div>
		</header>
		...
		<section>
			...
			<form method="post">
				<h3 class="bg-primary text-center pad-basic no-btm">Modificar Tarea </h3>
				...
				<div class="btn-der">
					<input type="submit" name="insertar" value="Modificar Tarea" class="btn btn-info"/>
				</div>
			...
			<?php
				...
				while(true) {
				    ...
				    ///////// QUERY DE INSERCIÓN ////////////////////////////
				    $sql = "UPDATE tareas SET $valoresQ";
